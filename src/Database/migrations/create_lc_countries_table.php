...
return new class() extends Migration
{
    ...
    public function up()
    {
        Schema::connection(WCountriesConnection::name())->create('lc_countries', function (Blueprint $table) {
    ...
    {
        Schema::connection(WCountriesConnection::name())->dropIfExists('lc_countries');
    }
};
