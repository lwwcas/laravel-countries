...
class HN_Honduras extends CountrySeeder
{
    ...
    public function run()
    {
        ...
        $this->internet_penetration = '32%'; // As of recent estimates

        // Set the national cybersecurity agency
        $this->cybersecurity_agency = 'National Cybersecurity Committee (Comité Nacional de Ciberseguridad)';

        // List popular web technologies in Honduras
        ...
        $this->currency = [
            ...
            'coins_main' => ['1', '2', '5'],
            // Subunit coins
            'coins_sub' => ['5', '10', '20', '50 centavos'],
        ];

        // Set the population
        $this->population = 9904608; // As per recent estimates
        ...
        $this->national_sport = 'Football (Soccer)'; // Football is the most popular sport in Honduras
        ...
        $this->coordinates = [
            ...
            'dd' => '15.2000° N, 86.2419° W',
            // Degrees, minutes, seconds
            'dms' => '15°12\'0.00" N, 86°14\'30.84" W',
            // Degrees and decimal minutes
            'dm' => '15°12.000\' N, 86°14.514\' W',
            // GPS formats
            'gps' => [],
        ];
