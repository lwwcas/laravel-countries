...
class AT_Austria extends CountrySeeder
{
    ...
    public function run()
    {
        ...
        $this->international_organizations = ['United Nations', 'European Union (EU)', 'Schengen Area', 'Eurozone', 'OECD', 'OSCE', 'European Economic Area (EEA)'];
