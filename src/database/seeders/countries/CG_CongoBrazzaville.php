...
class CG_CongoBrazzaville extends CountrySeeder
{
    ...
    public function run()
    {
        ...
        $this->official_name = 'Republic of the Congo';

        // Set the ISO 3166-1 alpha-2 code
        $this->iso_alpha_2 = 'CG';

        // Set the ISO 3166-1 alpha-3 code
        $this->iso_alpha_3 = 'COG';

        // Set the ISO 3166-1 numeric code (usually three digits)
        $this->iso_numeric = '178';

        // Set the international dialing code
        $this->international_phone = '242';
        ...
        $this->internet_penetration = '8%'; // Percentage of the population with internet access

        // Set the national cybersecurity agency
        $this->cybersecurity_agency = 'Agence Nationale de Sécurité des Systèmes d’Information (ANSSI)';

        // List popular web technologies in the Republic of the Congo
        ...
        // Set the population
        $this->population = 5518092; // As per recent estimates
        ...
        $this->independence_day = '1960-08-15'; // Date of independence from France
        ...
        $this->coordinates = [
            ...
            'gps' => [
                ...
                [
                    ...
                    // Coordinates in this format
                    'coordinates' => '041604.08S0151700.24E',
                ],
                [
                    // Format description
                    'format' => '[N,S] dd mm.mmm [E,W] ddd mm.mmm',
                    // Coordinates in this format
                    'coordinates' => 'S 4 16.068 E 15 17.004',
                ],
                [
                    // Format description
                    'format' => 'dd:mm:ss[N,S],ddd:mm:ss[E,W]',
                    // Coordinates in this format
                    'coordinates' => '4:16:04S,15:17:00E',
                ],
                [
                    // Format description
                    'format' => 'dd:mm:ss.ss[N,S] ddd:mm:ss.ss[E,W]',
                    // Coordinates in this format
                    'coordinates' => '4:16:04.08S 15:17:00.24E',
                ],
                [
                    // Format description
                    'format' => 'dd°mm\'ss"[N,S] ddd°mm\'ss"[E,W]',
                    // Coordinates in this format
                    'coordinates' => '4°16\'04"S 15°17\'00"E',
                ],
                [
                    // Format description
                    'format' => '[-]dd°mm\'ss" [-]ddd°mm\'ss"',
                    // Coordinates in this format
                    'coordinates' => '-4°16\'04" 15°17\'00"',
                ],
                [
                    // Format description
                    'format' => 'dd mm\' ss" [N,S] ddd mm\' ss" [E,W]',
                    // Coordinates in this format
                    'coordinates' => '4d 16\' 04" S 15d 17\' 00" E',
                ],
                [
                    // Format description
                    'format' => 'dd.dddd[N,S] ddd.dddd[E,W]',
                    // Coordinates in this format
                    'coordinates' => '4.2678S 15.2834E',
                ],
                [
                    // Format description
                    'format' => '[-]dd° mm.mmmmm [-]ddd° mm.mmmmm',
                    // Coordinates in this format
                    'coordinates' => '-4° 16.068, 15° 17.004',
                ],
                [
                    // Format description
                    'format' => '[-] mmmm.mmmmm, [-] mmmm.mmmmm',
                    // Coordinates in this format
                    'coordinates' => '-0416.068, 1517.004',
                ],
                [
                    // Format description
                    'format' => 'mmmm.mmmmm[N,S] mmmm.mmmmm[E,W]',
                    // Coordinates in this format
                    'coordinates' => '0416.068S, 1517.004E',
                ],
            ],
        ];
