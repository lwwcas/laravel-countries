...
class HR_Croatia extends CountrySeeder
{
    ...
    public function run()
    {
        ...
        $this->official_name = 'Republic of Croatia';
        ...
        $this->languages = ['hr']; // Croatian is the official language
        ...
        $this->cybersecurity_agency = 'Croatian National CERT';

        // List popular web technologies in Croatia
        $this->popular_technologies = ['PHP', 'JavaScript', 'HTML/CSS', 'WordPress', 'Drupal', 'Joomla'];
        ...
        // Set the population
        $this->population = 4047200; // As per recent estimates
        ...
        $this->gdp = 69; // GDP in billions of USD
        ...
        $this->national_sport = 'Football (Soccer)'; // Football is the most popular sport in Croatia
        ...
        $this->coordinates = [
            ...
            'dd' => '45.8150° N, 15.9819° E',
            // Degrees, minutes, seconds
            'dms' => '45°48\'54.00" N, 15°58\'54.84" E',
            // Degrees and decimal minutes
            'dm' => '45°48.900\' N, 15°58.914\' E',
            // GPS formats
            'gps' => [],
        ];
