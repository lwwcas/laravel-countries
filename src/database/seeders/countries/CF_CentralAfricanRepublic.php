...
class CF_CentralAfricanRepublic extends CountrySeeder
{
    ...
    public function run()
    {
        ...
        $this->languages = ['fr', 'sg']; // French and Sango are official languages
        ...
        $this->internet_speed = [
            ...
            'average_speed_fixed' => '5 Mbps', // Data may vary
            // Average mobile connection speed
            'average_speed_mobile' => '3 Mbps', // Data may vary
        ];
        ...
        // List popular web technologies in the Central African Republic
        $this->popular_technologies = ['PHP', 'JavaScript', 'WordPress']; // Limited due to low internet penetration

        // Set the WMO (World Meteorological Organization) country code
        $this->wmo = 'CF'; // Verify with official sources
        ...
        // Set the population
        $this->population = 4829764; // As of recent estimates
        ...
        $this->independence_day = '1960-08-13'; // Date of independence from France
        ...
        $this->gdp = 2.17; // GDP in billions of USD
        ...
        $this->coordinates = [
            // Latitude in decimal degrees (approximate center of the country)
            'latitude' => '6.6111',
            ...
            'gps' => [
                [
                    ...
                    'coordinates' => 'N6°36\'40.00", E20°56\'21.84"',
                ],
                [
                    // Format description
                    'format' => 'dd°mm\'ss.ssss"[N,S], ddd°mm\'ss.ssss"[E,W]',
                    // Coordinates in this format
                    'coordinates' => '6°36\'40.00"N, 20°56\'21.84"E',
                ],
                [
                    // Format description
                    'format' => '[-]dd mm ss.ssss, [-]ddd mm ss.ssss',
                    // Coordinates in this format
                    'coordinates' => '6 36 40.00, 20 56 21.84',
                ],
                [
                    // Format description
                    'format' => 'ISO 6709: [-]ddmmss.ssss, [-]dddmmss.ssss',
                    // Coordinates in this format
                    'coordinates' => '063640.00, 0205621.84',
                ],
                [
                    // Format description
                ...
                [
                    ...
                    // Coordinates in this format
                    'coordinates' => '6.61110°,20.93940°',
                ],
                [
                    // Format description
                    'format' => 'dd.ddddd[N,S]ddd.ddddd[E,W] (Dec Degs Micro)',
                    // Coordinates in this format
                    'coordinates' => '6.6111000N20.9394000E',
                ],
                [
                    // Format description
                    'format' => 'ddmm.mmmm[N,S]dddmm.mmmm[E,W] (Dec Min)',
                    // Coordinates in this format
                    'coordinates' => '0636.667N02056.364E',
                ],
                [
                    // Format description
                ...
                [
                    ...
                    // Coordinates in this format
                    'coordinates' => '063640.00N0205621.84E',
                ],
                [
                    // Format description
                    'format' => '[N,S] dd mm.mmm [E,W] ddd mm.mmm',
                    // Coordinates in this format
                    'coordinates' => 'N 6 36.667 E 20 56.364',
                ],
                [
                    // Format description
                    'format' => 'dd:mm:ss[N,S],ddd:mm:ss[E,W]',
                    // Coordinates in this format
                    'coordinates' => '6:36:40N,20:56:21E',
                ],
                [
                    // Format description
                    'format' => 'dd:mm:ss.ss[N,S] ddd:mm:ss.ss[E,W]',
                    // Coordinates in this format
                    'coordinates' => '6:36:40.00N 20:56:21.84E',
                ],
                [
                    // Format description
                    'format' => 'dd°mm\'ss"[N,S] ddd°mm\'ss"[E,W]',
                    // Coordinates in this format
                    'coordinates' => '6°36\'40"N 20°56\'21"E',
                ],
                [
                    // Format description
                    'format' => '[-]dd°mm\'ss" [-]ddd°mm\'ss"',
                    // Coordinates in this format
                    'coordinates' => '6°36\'40" 20°56\'21"',
                ],
                [
                    // Format description
                    'format' => 'dd mm\' ss" [N,S] ddd mm\' ss" [E,W]',
                    // Coordinates in this format
                    'coordinates' => '6d 36\' 40" N 20d 56\' 21" E',
                ],
                [
                    // Format description
                    'format' => 'dd.dddd[N,S] ddd.dddd[E,W]',
                    // Coordinates in this format
                    'coordinates' => '6.6111N20.9394E',
                ],
                [
                    // Format description
                    'format' => '[-]dd° mm.mmmmm [-]ddd° mm.mmmmm',
                    // Coordinates in this format
                    'coordinates' => '6° 36.667, 20° 56.364',
                ],
                [
                    // Format description
                    'format' => '[-] mmmm.mmmmm, [-] mmmm.mmmmm',
                    // Coordinates in this format
                    'coordinates' => '0636.667, 2056.364',
                ],
                [
                    // Format description
                    'format' => 'mmmm.mmmmm[N,S] mmmm.mmmmm[E,W]',
                    // Coordinates in this format
                    'coordinates' => '0636.667N2056.364E',
                ],
            ],
        ];
